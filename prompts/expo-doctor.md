...
5. If the issues is fixed, make sure to commit changes for package.json and bun-lock with the message `git add package.json bun-lock && git commit -m "fix(deps): expo doctor issues"`
